...
//     version 1.14.0
//     from Assets/Scripts/InputAction/TouchScreenAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/InputAction/TouchScreenAction.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @TouchScreenAction: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @TouchScreenAction()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""TouchScreenAction"",
    ""maps"": [
        {
            ""name"": ""TouchScreen"",
            ""id"": ""00d87b52-73a2-4c7e-95e1-65f2413527b3"",
            ""actions"": [
                {
                    ""name"": ""PressScreen"",
                    ""type"": ""Button"",
                    ""id"": ""89ec29be-b7ca-4f69-959b-9b9f46d39426"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""TouchPosition"",
                    ""type"": ""Value"",
                    ""id"": ""13c4be5c-04b7-4904-b2fd-5c37ec2717a9"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""b0d8a886-2f60-498d-8cbb-924b66d8b022"",
                ...
                {
                    ""name"": """",
                    ""id"": ""f9d25a0f-fd78-4cbb-8542-ef66a4afa504"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2ee6fda3-b1d2-4c8d-b159-9d5e8737f03a"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""ac6755b3-2c85-40e8-b481-0188758ee481"",
    ...
    ""controlSchemes"": []
        ...
        m_TouchScreen_PressScreen = m_TouchScreen.FindAction("PressScreen", throwIfNotFound: true);
        m_TouchScreen_TouchPosition = m_TouchScreen.FindAction("TouchPosition", throwIfNotFound: true);
    }

    ~@TouchScreenAction()
    {
        UnityEngine.Debug.Assert(!m_TouchScreen.enabled, "This will cause a leak and performance issues, TouchScreenAction.TouchScreen.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_TouchScreen_PressScreen;
    ...
    {
        private @TouchScreenAction m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TouchScreenActions(@TouchScreenAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "TouchScreen/PressScreen".
        /// </summary>
        public InputAction @PressScreen => m_Wrapper.m_TouchScreen_PressScreen;
        /// <summary>
